...
func ConvertParams(methodParams []*MethodParam, methodType reflect.Type, ctx *context.Context) (result []reflect.Value) {
...
func convertParam(param *MethodParam, paramType reflect.Type, ctx *context.Context) (result reflect.Value) {
...
func getParamValue(param *MethodParam, ctx *context.Context) string {
	switch param.in {
	case body:
