...
// HttpInput operates the http request header, data, cookie and body.
...
// NewInput return HttpInput generated by Context.
func NewInput() *HttpInput {
	return &HttpInput{
...
// Reset init the HttpInput
func (input *HttpInput) Reset(ctx *Context) {
	input.Context = ctx
...
func (input *HttpInput) Host() string {
...
func (input *HttpInput) Domain() string {
	return input.Host()
}

// Site returns base site url as scheme://domain type.
func (input *HttpInput) Site() string {
	return input.Scheme() + "://" + input.Domain()
}

// Method returns http request method.
func (input *HttpInput) Method() string {
	return input.Context.Request.Method
}

// Is returns boolean of this request is on given method, such as Is("POST").
func (input *HttpInput) Is(method string) bool {
	return input.Method() == method
}

// IsGet Is this a GET method request?
func (input *HttpInput) IsGet() bool {
	return input.Is("GET")
}

// IsPost Is this a POST method request?
func (input *HttpInput) IsPost() bool {
	return input.Is("POST")
}

// IsHead Is this a Head method request?
func (input *HttpInput) IsHead() bool {
	return input.Is("HEAD")
}

// IsOptions Is this a OPTIONS method request?
func (input *HttpInput) IsOptions() bool {
	return input.Is("OPTIONS")
}

// IsPut Is this a PUT method request?
func (input *HttpInput) IsPut() bool {
	return input.Is("PUT")
}

// IsDelete Is this a DELETE method request?
func (input *HttpInput) IsDelete() bool {
	return input.Is("DELETE")
}

// IsPatch Is this a PATCH method request?
func (input *HttpInput) IsPatch() bool {
	return input.Is("PATCH")
}

// IsAjax returns boolean of this request is generated by ajax.
func (input *HttpInput) IsAjax() bool {
	return input.Header("X-Requested-With") == "XMLHttpRequest"
}

// IsSecure returns boolean of this request is in https.
func (input *HttpInput) IsSecure() bool {
	return input.Scheme() == "https"
}

// IsWebsocket returns boolean of this request is in webSocket.
func (input *HttpInput) IsWebsocket() bool {
	return input.Header("Upgrade") == "websocket"
}

// IsUpload returns boolean of whether file uploads in this request or not..
func (input *HttpInput) IsUpload() bool {
	return strings.Contains(input.Header("Content-Type"), "multipart/form-data")
}

// AcceptsHTML Checks if request accepts html response
func (input *HttpInput) AcceptsHTML() bool {
	return acceptsHTMLRegex.MatchString(input.Header("Accept"))
}

// AcceptsXML Checks if request accepts xml response
func (input *HttpInput) AcceptsXML() bool {
	return acceptsXMLRegex.MatchString(input.Header("Accept"))
}

// AcceptsJSON Checks if request accepts json response
func (input *HttpInput) AcceptsJSON() bool {
...
func (input *HttpInput) IP() string {
	ips := input.Proxy()
	if len(ips) > 0 && ips[0] != "" {
...
func (input *HttpInput) Proxy() []string {
...
func (input *HttpInput) Referer() string {
	return input.Header("Referer")
}

// Refer returns http referer header.
func (input *HttpInput) Refer() string {
	return input.Referer()
}

// SubDomains returns sub domain string.
// if aa.bb.domain.com, returns aa.bb .
func (input *HttpInput) SubDomains() string {
...
func (input *HttpInput) UserAgent() string {
	return input.Header("User-Agent")
}

// ParamsLen return the length of the params
func (input *HttpInput) ParamsLen() int {
	return len(input.pnames)
}

// Param returns router param by a given key.
func (input *HttpInput) Param(key string) string {
...
func (input *HttpInput) Params() map[string]string {
...
func (input *HttpInput) SetParam(key, val string) {
...
// passes.
func (input *HttpInput) ResetParams() {
	input.pnames = input.pnames[:0]
	input.pvalues = input.pvalues[:0]
}

// Query returns input data item string by a given string.
func (input *HttpInput) Query(key string) string {
...
// if non-existed, return empty string.
func (input *HttpInput) Cookie(key string) string {
...
func (input *HttpInput) Session(key interface{}) interface{} {
	return input.CruSession.Get(key)
}

// CopyBody returns the raw request body data as bytes.
func (input *HttpInput) CopyBody(MaxMemory int64) []byte {
...
func (input *HttpInput) Data() map[interface{}]interface{} {
	if input.data == nil {
...
func (input *HttpInput) GetData(key interface{}) interface{} {
...
func (input *HttpInput) SetData(key, val interface{}) {
	if input.data == nil {
		input.data = make(map[interface{}]interface{})
	}
	input.data[key] = val
...
func (input *HttpInput) ParseFormOrMulitForm(maxMemory int64) error {
...
// like /?id=123&isok=true&ft=1.2&ol[0]=1&ol[1]=2&ul[]=str&ul[]=array&user.Name=test
// var id int  HttpInput.Bind(&id, "id")  id ==123
// var isok bool  HttpInput.Bind(&isok, "isok")  isok ==true
// var ft float64  HttpInput.Bind(&ft, "ft")  ft ==1.2
// ol := make([]int, 0, 2)  HttpInput.Bind(&ol, "ol")  ol ==[1 2]
// ul := make([]string, 0, 2)  HttpInput.Bind(&ul, "ul")  ul ==[str array]
// user struct{Name}  HttpInput.Bind(&user, "user")  user == {Name:"test"}
func (input *HttpInput) Bind(dest interface{}, key string) error {
...
func (input *HttpInput) bind(key string, typ reflect.Type) reflect.Value {
	if input.Context.Request.Form == nil {
		input.Context.Request.ParseForm()
	}
	rv := reflect.Zero(typ)
...
func (input *HttpInput) bindValue(val string, typ reflect.Type) reflect.Value {
	rv := reflect.Zero(typ)
	switch typ.Kind() {
	case reflect.Int, reflect.Int8, reflect.Int16, reflect.Int32, reflect.Int64:
		rv = input.bindInt(val, typ)
...
func (input *HttpInput) bindInt(val string, typ reflect.Type) reflect.Value {
...
func (input *HttpInput) bindUint(val string, typ reflect.Type) reflect.Value {
...
func (input *HttpInput) bindFloat(val string, typ reflect.Type) reflect.Value {
...
func (input *HttpInput) bindString(val string, typ reflect.Type) reflect.Value {
	return reflect.ValueOf(val)
}

func (input *HttpInput) bindBool(val string, typ reflect.Type) reflect.Value {
...
func (input *HttpInput) bindSlice(params *url.Values, key string, typ reflect.Type) reflect.Value {
	maxIndex := -1
	numNoIndex := 0
...
func (input *HttpInput) bindStruct(params *url.Values, key string, typ reflect.Type) reflect.Value {
...
func (input *HttpInput) bindPoint(key string, typ reflect.Type) reflect.Value {
	return input.bind(key, typ.Elem()).Addr()
}

func (input *HttpInput) bindMap(params *url.Values, key string, typ reflect.Type) reflect.Value {
	var (
